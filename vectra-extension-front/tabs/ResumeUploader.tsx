...
const ResumeUploader = () => {
  ...
  return (
    ...
    <Header />
    <div
      className="flex flex-row items-center justify-center mt-36"
      onDrop={handleDrop}
        ...
        <div className="bg-white px-10 py-5 border-md shadow-lg ring-1 ring-inset ring-gray-300">
          {error ? (
            <div className="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
              ...
              <div>
                <span className="font-medium">Server error! </span>Please try again later.
              </div>
            </div>
            ) :(
          ...
          <div className=" flex flex-row  gap-2 mt-5 ">
            <button
              ...
              >
                {isloading ? (
                  <svg aria-hidden="true" className="inline w-3 h-5 text-white animate-spin dark:text-white fill-gray-600 dark:fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
